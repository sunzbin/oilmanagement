        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/labelAxis/getAxisInfo",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '标签类型', '车型代码', '车号', '轴位','点位','油脂类型代码'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        			...
        			editurl : "${contextPath}/labelAxis/operateLabelAxis"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
            ...
            $('#upload').click(function(){
            	layer.open({
                    ...
                    area: ['690px', '640px'],
                    content: '${contextPath}/labelAxis/read',
                    end: function () {
